    ...
    <div class="container">
        <div class="success-container">
            ...
            <div class="success-header">
                ...
                <p class="success-subtitle">Thank you for shopping with us. Your order has been confirmed and is being processed.</p>
            </div>
                ...
                <div class="modern-card-body">
                    <div class="detail-grid">
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value">{{ $order->created_at->format('M d, Y \a\t h:i A') }}</div>
                        </div>
                        <div class="detail-item">
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                <span class="status-badge {{ $order->payment_status === 'completed' ? 'status-success' : 'status-warning' }}">
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                <span class="status-badge status-primary">{{ ucfirst($order->status) }}</span>
                            </div>
                        </div>
                        <div class="detail-item">
            ...
            <div class="modern-card">
                ...
                <div class="modern-card-body">
                    ...
                    @if($order->discount > 0)
                    <div class="summary-row">
                        <span class="summary-label discount-text">Discount:</span>
                        <span class="summary-value discount-text">-₹{{ number_format($order->discount, 2) }}</span>
                    </div>
                    @endif
                    <div class="summary-row">
                        <span class="summary-label">Shipping:</span>
                        <span class="summary-value">₹{{ number_format($order->shipping_charge, 2) }}</span>
                    </div>
                    <div class="summary-row">
            ...
            @if($order->notes)
            <div class="notes-alert mt-4">
                <strong><i class="fas fa-sticky-note me-2"></i>Order Notes:</strong> {{ $order->notes }}
            </div>
            @endif
        </div>
    </div>
